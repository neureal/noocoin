...
public:
	...
	bool CreateCoinageTransaction(const CScript& csData, int64 nValue, CWalletTx& wtxNew, int64& nFeeRet);
	bool CreateDataTransaction(const CScript& csData, CWalletTx& wtxNew);
