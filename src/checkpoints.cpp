...
namespace Checkpoints
{
    ...
    // noocoin: synchronized checkpoint (centrally broadcasted)
    ...
    // noocoin: get last synchronized checkpoint
    ...
    // noocoin: only descendant of current sync-checkpoint is allowed
    ...
    // noocoin: reset synchronized checkpoint to last hardened checkpoint
...
// noocoin: sync-checkpoint master key
...
// noocoin: verify signature of sync-checkpoint message
...
// noocoin: process synchronized checkpoint
